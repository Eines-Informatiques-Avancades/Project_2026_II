...
program, including: 
\begin{itemize}
    \item \textbf{Git/Github} as a code respository \& teamwork coordination platform
    \item \textbf{Makefile} to automate the compilation and execution of the code
    \item \textbf{Shell scripting} for facilitating server deployment
    \item \textbf{MPI \& openMP} to parallelize the code
    \item \textbf{Python} for post-processing and plotting
\end{itemize}